    ...
    <>
      <div className={css.Virtual} id="about">
        <div className={css.left}>
          ...
          <p style={{ fontSize: "1.1rem", fontWeight: 400, lineHeight: 1.5 ,letterSpacing:'1px'}}>
            Savi Ruchi, where culinary excellence meets convenience. Founded in
            2021 by the dynamic duo Sneha and Hitesh.
            <br />
            <span style={{ marginRight: "2rem" }} /> Savi Ruchi has
...
<div style={{padding:'0.3rem'}}/>
        ...
        <div className={css.right}>
          <div className={css.wrapper}>
            <ReactCompareImage leftImage={Before} rightImage={After} vertical />
          </div>
        </div>
      </div>
